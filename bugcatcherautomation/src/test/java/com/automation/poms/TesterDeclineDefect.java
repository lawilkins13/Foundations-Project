...
public class TesterDeclineDefect {
    ...
    public WebElement updateDecline;

    @FindBy(tagName = "Button")
    public WebElement updatestatusButton;

    public void testerEnterDefectNameDecline(String defectIDDecline){
        this.testerEnterDefectNameDecline.sendKeys(defectIDDecline);
    }
    public void dropdownDecline(){
        Select dropdownDeclineChoice = new Select(driver.findElement(By.id("Accept-or-Reject")));
    ...
    public void updateDeclineStatusButton(){
        this.updatestatusButton.click();
        WebDriverWait waitDecline = new WebDriverWait(driver,3);
